<template>
    <div>
      ...
      <div v-else>
        <div v-if="arrivedOrders.length == 0">
          <p class="mt-[20px] font-semibold text-red-500 text-[15px]">No arrived orders found...</p>
        </div>
        ...
        >
          ...
          <p class="bg-green-500 text-white px-[20px] py-[10px] w-[140px] rounded-[5px] text-center">{{ order.status }}</p>
        </router-link>
      </div>
    </div>
</template>
