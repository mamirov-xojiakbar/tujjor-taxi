  ...
  <div class="bg-[#F7931E] fixed w-full z-50">
    <div class="container mx-auto py-6 flex justify-between items-center">
      ...
      <div class="flex items-center gap-8 text-white text-lg font-medium">
        <router-link :to="{ name: 'about' }" class="md:block hidden">{{
          aboutUsText
        }}</router-link>
        ...
        <router-link to="#">
          ...
          >
            <path
              fill="white"
              d="M256 288a144 144 0 1 0 0-288a144 144 0 1 0 0 288m-94.7 32C72.2 320 0 392.2 0 481.3c0 17 13.8 30.7 30.7 30.7h450.6c17 0 30.7-13.8 30.7-30.7c0-89.1-72.2-161.3-161.3-161.3z"
            />
          </svg>
        </router-link>
      </div>
...
const aboutUsText = computed(() =>
  languageStore.isRussian ? "О нас" : "Biz haqimizda"
);
const faqText = computed(() =>
  languageStore.isRussian ? "Вопрос/Ответ" : "Savol/javob"
);
</script>
